...
class MixtureDensityNetwork(pl.LightningModule):
    ...
    """
    def __init__(self, input_size, sample_size, n_components, beta=0., learning_rate=0.005, hidden_pi=None, hidden_normal=None):
...
def ex_1d(n_iterations: int = 2000, datapoints=512, batch_size=512, workers=4, gpu=False):
